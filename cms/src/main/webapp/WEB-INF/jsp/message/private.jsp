...
<div style="margin: 0 0 20px;">
    <div style="position: relative;float: left;width: 190px;margin-right: -190px">
        ...
        <button class="btn btn-success center-block" data-toggle="modal" data-target="#privateMessage" type="button">发私信</button>
                    ...
                    <div class="modal-body">
                        <form action="" id="messageForm" method="post" class="text-center">
                            <div class="form-group">
                                <label>收信人：</label>
                                <input type="text" id="receiveName" name="receiveName" placeholder="请输入收信人" />
                                <label>
...
<script>
    $(function () {
        $(".closeRead").each(function() {
            $(this).click(function() {
                $.post("/Message/Private/readStatus/", {id: $(this).attr("data-id")}, function() {
