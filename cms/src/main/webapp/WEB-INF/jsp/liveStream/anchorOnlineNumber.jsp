...
<script>
    $(function () {
        ...
        var data2 = [];
        var data3 = [];
        var value1 = Math.random() * 5000 + 15000;
        var value2 = Math.random() * 3000 + 9000;
        var value3 = Math.random() * 2000 + 6000;
        for (var i = 0; i < 100; i++) {
        ...
        function randomData1() {
            value1 = value1 + Math.random() * 1000 - 500;
            return Math.round(value1);
        }
        function randomData2() {
            value2 = value2 + Math.random() * 600 - 300;
            return Math.round(value2);
        }
        function randomData3() {
            value3 = value3 + Math.random() * 400 - 200;
