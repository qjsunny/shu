                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title text-center"><strong>企业广告认证</strong></h4>
                                    </div>
                                    <div class="modal-body">
                                        <div style="padding: 15px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <img src="${el.advertisement}" style="height: 364px; width: 273px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function () {
        $(".success").each(function() {
            $(this).click(function() {
                $.post("/Enterprise/authentication/advertisement/success", {id: $(this).attr("data-id")}, function() {
