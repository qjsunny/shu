...
<script src="/js/manager/update.js"></script>
...
<div class="panel panel-default center-block" style="width:400px; padding:30px; margin-top:50px;">
    <form action="" id="managerAddForm" method="post" class="text-center">
        <div class="form-group">
            ...
            <input type="text" id="username" name="username" placeholder="请输入用户名" readonly="true" />
        </div>
        <div class="form-group">
    ...
    <div class="text-center">
        <input type="button" id="add" value="更新" class="btn btn-success">
